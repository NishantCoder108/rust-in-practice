...
mod tests {
    ...
    fn setup() -> (LiteSVM, Keypair) {
        ...
        // The solana_account::Account and litesvm::Account might be different types, so we need to convert explicitly.
        // program.set_account(
        //     payer.pubkey(),
        //     litesvm::Account {
        //         lamports: fetched_account.lamports,
        //         data: fetched_account.data,
        //         owner: litesvm::Pubkey::from_bytes(fetched_account.owner.as_ref()),
