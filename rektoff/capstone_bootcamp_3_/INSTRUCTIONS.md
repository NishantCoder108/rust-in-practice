...
2. **Exploit them** by writing PoC test cases for at least 2/3 high vulnerability.
...
6. **Proof of Concept** — Code demonstrating the exploit.or check file some related stuff.
